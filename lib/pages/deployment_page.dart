...
class DeploymentPage extends StatelessWidget {
  ...
  final List<Map<String, String>> deployments = const [
    ...
    },
    {
      ...
      "title": "Deployment 9",
      "description": "AWaDH CPS Lab launched at Khalsa College of Engineering and Technology (KCET), Amritsar.",
      "longDescription":
    ...
    },
    {
      ...
      "title": "Deployment 14",
      "description": "AWaDH CPS Lab launched at Sardar Vallabhbhai Patel University of Agriculture and Technology, Meerut.",
      "longDescription":
